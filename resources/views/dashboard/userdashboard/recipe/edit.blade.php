        ...
        <div class=" rounded border-2  shadow-md">
            ...
            <div class="block m-4 mt-4 text-center">
                ...
                <textarea type="text" name="steps" rows="10" placeholder="Burn for 30 minutes in the oven" required
                    class="mt-1 px-2 py-1 bg-white border shadow-sm border-slate-300 placeholder-slate-400 focus:outline-none focus:border-sky-500 focus:ring-sky-500 block w-full rounded-md text-sm focus:ring-1 ">{{ old('steps', $recipe->steps) }}</textarea>
            </div>
