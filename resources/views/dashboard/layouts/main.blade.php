...
@include('partials.navbar')
  ...
  <div class="p-2 mt-5"><a href="#" class="btn btn-success"><i class="bi bi-pen-fill"></i></a></div>
  <div class="p-2 mt-5"><a href="#" class="btn btn-primary"><i class="bi bi-bar-chart-fill"></i></a></div>
  <div class="p-2 mt-5 me-2"><a href="#" class="btn btn-secondary"><i class="bi bi-gear-fill"></i></a></div>  
</div>
